...
**65 §4 constraints · 139 ADRs · 118 active gate rules · 252 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 160 enforcer
rows, and a 640-node / 1241-edge architecture graph — all maintained in
