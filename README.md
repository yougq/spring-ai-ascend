...
**65 §4 constraints · 139 ADRs · 126 active gate rules · 264 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 166 enforcer
rows, and a 646-node / 1253-edge architecture graph — all maintained in
