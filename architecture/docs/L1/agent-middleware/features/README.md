...
# `agent-middleware` — L1 Feature Catalog (9-section)

This catalog is the **rendered** human-readable view of the
`agent-middleware`-owned features registered in
...
The module `agent-middleware` has no SAA Feature elements declared in
